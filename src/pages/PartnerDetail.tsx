...
import { ArrowLeft, ExternalLink, Calendar, MapPin, Mail, Phone, Loader2 } from "lucide-react";
            ...
            <div className="relative grid md:grid-cols-[1.5fr,1fr] gap-16 items-center">
              <div className="space-y-6">
                {partner.type_partenaire && (
                  <Badge className="mb-2 text-sm px-4 py-1.5">{partner.type_partenaire}</Badge>
                )}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-lg">
                          {new Date(partner.date_creation_entreprise).getFullYear()}
                        </p>
                      </div>
                    </div>
                  )}
                  {partner.adresse && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-lg">{partner.adresse}</p>
                      </div>
                    </div>
                  )}
                  {partner.date_deb && (
                ...
                <div className="pt-6 border-t border-border/50 mt-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    {partner.telephone && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <a href={`tel:${partner.telephone}`} className="text-primary hover:underline">
                          {partner.telephone}
                        </a>
                      </div>
                    )}
                  ...
                  {partner.date_fin && (
                    <div className="mt-4 text-sm text-muted-foreground">
                      Partnership Period: {new Date(partner.date_deb).toLocaleDateString()} - {new Date(partner.date_fin).toLocaleDateString()}
                    </div>
                  )}
                </div>
                ...
                <div className="relative mb-16">
                  ...
                  <div className="relative">
                    <h3 className="text-5xl md:text-6xl lg:text-7xl font-black mb-12 leading-tight">
                      {t('partner.aboutTitle')} {partner.nom_partenaire}
                    </h3>
          ...
          <section className="container mx-auto px-6 mb-16">
            ...
            >
              <img
                ...
                alt={`${partner.nom_partenaire} banner`}
